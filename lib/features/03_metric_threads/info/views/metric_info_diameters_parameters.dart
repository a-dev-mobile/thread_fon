...
class MetricInfoDiametersParameters extends StatelessWidget {
  ...
  const MetricInfoDiametersParameters({required this.info, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    diameterSections.add(
      _buildPrimaryDiameterSection(prefix, isFemale, localization),
    );
    ...
    diameterSections.addAll(
      _buildAdditionalSections(prefix, isFemale, localization),
    );
        ...
        Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              _DiameterItem(diameter: diameter, dEs: dEs, dEi: dEi),
            ],
          ),
        ),
...
class _DiameterItem extends StatelessWidget {
  ...
  const _DiameterItem({required this.diameter, this.dEs, this.dEi});
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: <Widget>[
        Text(diameter.toString(), style: Theme.of(context).textTheme.bodyLarge),
