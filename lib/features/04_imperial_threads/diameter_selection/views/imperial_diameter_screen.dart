...
import 'package:threadfon/features/04_imperial_threads/diameter_selection/bloc/imperial_diameter_bloc.dart';
import 'package:threadfon/features/04_imperial_threads/diameter_selection/models/imperial_diameter_model.dart';
import 'package:threadfon/features/04_imperial_threads/diameter_selection/repositories/imperial_diameter_repository.dart';
import 'package:threadfon/features/04_imperial_threads/diameter_selection/views/widget/imperial_diameter_choice_card.dart';
    ...
    return BlocListener<ImperialDiameterBloc, ImperialDiameterState>(
      ...
      listener: (BuildContext context, ImperialDiameterState state) async {
        if (state.enumNavigationStatus.isNavigation) {
          ...
          await context.pushNamed(ImperialToleranceSelectionScreen.name);
