...
class TrapezoidalFullScreenSvgView extends StatefulWidget {
  ...
  _TrapezoidalFullScreenSvgViewState createState() =>
      _TrapezoidalFullScreenSvgViewState();
}

class _TrapezoidalFullScreenSvgViewState
    extends State<TrapezoidalFullScreenSvgView> {
  @override
  void initState() {
    super.initState();
