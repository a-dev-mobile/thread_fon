...
sealed class TrapezoidalToleranceState with _$TrapezoidalToleranceState {
  const factory TrapezoidalToleranceState({
    @Default(<TrapezoidalToleranceItem>[])
    List<TrapezoidalToleranceItem> femaleTolerances,
    @Default(<TrapezoidalToleranceItem>[])
    List<TrapezoidalToleranceItem> maleTolerances,
  ...
  factory TrapezoidalToleranceState.fromJson(Map<String, dynamic> json) =>
      _$TrapezoidalToleranceStateFromJson(json);
}
