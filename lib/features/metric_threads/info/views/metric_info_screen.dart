...
class _MetricInfoViewState extends State<_MetricInfoView> {
  ...
  Widget _buildContent(
      MetricInfoBloc bloc, BuildContext context, double overlayHeight, double svgWidth, double svgHeight) {
    final state = bloc.state;
  ...
  Widget _buildSuccessContent(BuildContext context, MetricInfoState state, MetricInfoBloc bloc, double overlayHeight) {
