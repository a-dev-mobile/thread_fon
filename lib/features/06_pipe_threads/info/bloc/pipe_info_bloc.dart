...
class PipeInfoBloc extends Cubit<PipeInfoState>
  ...
  Future<void> load() async {
    ...
    try {
      final PipeUserSelection pipeUserSelection = await _localStorage
          .getPipeUserSelection();
      final CoreUserSelection coreUserSelection = await _localStorage
          .getCoreUserSelection();
      final PipeInfoModel model = await _fetchModel(
        coreUserSelection,
        pipeUserSelection,
      );
      emit(
  ...
  Future<PipeInfoModel> _fetchModel(
    CoreUserSelection coreUserSelection,
    PipeUserSelection pipeUserSelection,
  ) async {
  ...
  void toggleSvgOverlay() {
    ...
    _localStorage.updatePipeUserSelection(
      (PipeUserSelection current) =>
