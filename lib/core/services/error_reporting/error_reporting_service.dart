    ...
    try {
      ...
      final errorReport = {
        ...
        'immutableData': {
          ...
          // Базовая информация о приложении (не меняется в течение сессии)
          'platform': _platform,
          'app_name': _appName,
          ...
          // Информация об устройстве (не меняется в течение сессии)
        ...
        'mutableData': {
          ...
          // Динамическое состояние приложения
          ...
          'platform_brightness':
              PlatformDispatcher.instance.platformBrightness.toString(),
