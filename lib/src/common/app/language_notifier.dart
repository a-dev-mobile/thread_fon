...
class LanguageNotifier extends InheritedNotifier<ValueNotifier<String>> {
  ...
  static LanguageNotifier? ofNotifier(BuildContext context) => context.dependOnInheritedWidgetOfExactType<LanguageNotifier>();
  ...
  static Future<String> loadLocale() async {
    ...
    return prefs.getString('locale') ?? PlatformDispatcher.instance.locale.languageCode;
  }
}
