...
class LocalStorage {
  ...
  Future<void> initialize() async {
    ...
    _l.iNoStack('INITIALIZE LocalStorage');
  }
  ...
  Future<void> setPathDB(String? value) => _setValue<String>(key: ConstStorage.keyPathDB, value: value ?? '');
  ...
  Future<void> _log(String action, String key, dynamic value) async {
    if (_isShowLog) {
      _l.iNoStack('$action > $key, Value: $value');
    }
  }
