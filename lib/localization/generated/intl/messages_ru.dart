...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "app_icon_alt": MessageLookupByLibrary.simpleMessage("Иконка приложения"),
    "app_lang": MessageLookupByLibrary.simpleMessage("Язык приложения"),
    "app_name": MessageLookupByLibrary.simpleMessage("Резьбушка"),
    "app_store_not_found": MessageLookupByLibrary.simpleMessage(
      "AppStore не найден",
    ),
    ...
    "choose_thread": MessageLookupByLibrary.simpleMessage("Выбрать резьбу"),
    "cmax_label": MessageLookupByLibrary.simpleMessage(
      "Cmax - Максимальное усечение вершины",
    ),
    "cmin_label": MessageLookupByLibrary.simpleMessage(
      "Cmin - Минимальное усечение вершины",
    ),
    "crestTruncation": MessageLookupByLibrary.simpleMessage(
      "H/8 - Усечение вершины",
    ),
    ...
    "d3_label": MessageLookupByLibrary.simpleMessage(
      "d3 - Диаметр по впадине резьбы (внутренний)",
    ),
    ...
    "dialog_about_app_1": MessageLookupByLibrary.simpleMessage(
      "- Допуски наружного диаметра",
    ),
    "dialog_about_app_2": MessageLookupByLibrary.simpleMessage(
      "- Допуски среднего диаметра",
    ),
    "dialog_about_app_3": MessageLookupByLibrary.simpleMessage(
      "- Допуски внутреннего диаметра",
    ),
    "dialog_about_app_4": MessageLookupByLibrary.simpleMessage("---"),
    "dialog_about_app_5": MessageLookupByLibrary.simpleMessage(
      "Всегда проверяйте результаты!",
    ),
    "dialog_title_about_app": MessageLookupByLibrary.simpleMessage(
      "С помощью данного приложения вы можете определить основные параметры резьбы, а также:",
    ),
    "diam_major": MessageLookupByLibrary.simpleMessage("Наружный диаметр"),
    "diam_middle": MessageLookupByLibrary.simpleMessage("Средний диаметр"),
    "diam_minor": MessageLookupByLibrary.simpleMessage("Внутренний диаметр"),
    ...
    "external_thread": MessageLookupByLibrary.simpleMessage("Наружная резьба"),
    ...
    "halfPitch": MessageLookupByLibrary.simpleMessage("P/2 - Полушаг"),
    "heightOfFundamentalTriangle": MessageLookupByLibrary.simpleMessage(
      "H - Высота исходного треугольника профиля",
    ),
    "imperial_thread": MessageLookupByLibrary.simpleMessage(
      "Унифицированная дюймовая резьба",
    ),
    "imperial_thread_gost": MessageLookupByLibrary.simpleMessage(
      "ASME/ANSI B1.1",
    ),
    "inch": MessageLookupByLibrary.simpleMessage("дюйм"),
    "internal_thread": MessageLookupByLibrary.simpleMessage(
      "Внутренняя резьба",
    ),
    ...
    "leave_feedback": MessageLookupByLibrary.simpleMessage("Оставить отзыв"),
    ...
    "m_thread_female_description": MessageLookupByLibrary.simpleMessage(
      "M - Метрическая внутренняя цилиндрическая резьба",
    ),
    "m_thread_gost": MessageLookupByLibrary.simpleMessage(
      "ГОСТ 24705-2004 / ISO 965",
    ),
    ...
    "major_diam_avg": MessageLookupByLibrary.simpleMessage(
      "Средний основной диаметр",
    ),
    "major_diam_max": MessageLookupByLibrary.simpleMessage(
      "Макс. основной диаметр",
    ),
    "major_diam_min": MessageLookupByLibrary.simpleMessage(
      "Мин. наружный диаметр",
    ),
    "major_diam_tolerance": MessageLookupByLibrary.simpleMessage(
      "Допуск основного диаметра",
    ),
    "max": MessageLookupByLibrary.simpleMessage("макс"),
    "mean": MessageLookupByLibrary.simpleMessage("сред."),
    "metric_thread": MessageLookupByLibrary.simpleMessage("Метрическая резьба"),
    "metric_thread_gost": MessageLookupByLibrary.simpleMessage(
      "ГОСТ 24705-2004 / ISO 965",
    ),
    ...
    "minor_diam_d1": MessageLookupByLibrary.simpleMessage(
      "Внутренний диаметр D1",
    ),
    "minor_diam_d3": MessageLookupByLibrary.simpleMessage(
      "Внутренний диаметр D3",
    ),
    "minor_diam_max": MessageLookupByLibrary.simpleMessage(
      "Макс. внутренний диаметр",
    ),
    "minor_diam_min": MessageLookupByLibrary.simpleMessage(
      "Мин. внутренний диаметр",
    ),
    "minor_diam_tolerance": MessageLookupByLibrary.simpleMessage(
      "Допуск внутреннего диаметра",
    ),
    "minor_diameter_unr": MessageLookupByLibrary.simpleMessage(
      "Внутренний диаметр UNR",
    ),
    "mm_long": MessageLookupByLibrary.simpleMessage("миллиметр"),
    "mm_short": MessageLookupByLibrary.simpleMessage("мм"),
    "no": MessageLookupByLibrary.simpleMessage("Нет"),
    "no_data": MessageLookupByLibrary.simpleMessage("Нет данных"),
    "no_internet": MessageLookupByLibrary.simpleMessage(
      "Нет подключения к интернету",
    ),
    "no_svg_data": MessageLookupByLibrary.simpleMessage(
      "Нет данных для отображения",
    ),
    "nuts": MessageLookupByLibrary.simpleMessage("Гайка"),
    "pipe_thread": MessageLookupByLibrary.simpleMessage(
      "Трубная цилиндрическая резьба",
    ),
    "pipe_thread_gost": MessageLookupByLibrary.simpleMessage(
      "ГОСТ 6357-81, ISO 228",
    ),
    "pitch": MessageLookupByLibrary.simpleMessage("Шаг"),
    "pitch_diam": MessageLookupByLibrary.simpleMessage("Средний диаметр"),
    "pitch_diam_avg": MessageLookupByLibrary.simpleMessage(
      "Средний диаметр шага",
    ),
    "pitch_diam_d2": MessageLookupByLibrary.simpleMessage("Средний диаметр D2"),
    "pitch_diam_max": MessageLookupByLibrary.simpleMessage(
      "Макс. средний диаметр",
    ),
    "pitch_diam_min": MessageLookupByLibrary.simpleMessage(
      "Мин. средний диаметр",
    ),
    "pitch_diam_tolerance": MessageLookupByLibrary.simpleMessage(
      "Допуск среднего диаметра",
    ),
    "precision": MessageLookupByLibrary.simpleMessage("Точность"),
    "quarterPitch": MessageLookupByLibrary.simpleMessage("P/4 - Четверть шага"),
    ...
    "rmax_label": MessageLookupByLibrary.simpleMessage(
      "Rmax - Макс. радиус закругления впадины",
    ),
    "rmin_label": MessageLookupByLibrary.simpleMessage(
      "Rmin - Мин. радиус закругления впадины",
    ),
    "rootTruncation": MessageLookupByLibrary.simpleMessage(
      "H/4 - Усечение впадины",
    ),
    "select_class": MessageLookupByLibrary.simpleMessage("Выберите класс"),
    "select_diameter": MessageLookupByLibrary.simpleMessage("Выберите диаметр"),
    "select_diameter_and_pitch": MessageLookupByLibrary.simpleMessage(
      "Выберите диаметр и шаг",
    ),
    "select_pitch": MessageLookupByLibrary.simpleMessage("Выберите шаг"),
    "select_tolerance": MessageLookupByLibrary.simpleMessage("Выберите допуск"),
    "send_email": MessageLookupByLibrary.simpleMessage("Отправить email"),
    ...
    "settings_header_subtitle": MessageLookupByLibrary.simpleMessage(
      "Рекомендуется сверять результаты с официальными справочниками.",
    ),
    "suggest_improvement": MessageLookupByLibrary.simpleMessage(
    ...
    "thread_class": MessageLookupByLibrary.simpleMessage("Класс резьбы"),
    "thread_class_tolerance": MessageLookupByLibrary.simpleMessage(
      "Класс допуска",
    ),
    "thread_depth": MessageLookupByLibrary.simpleMessage("Глубина резьбы"),
    "thread_designation": MessageLookupByLibrary.simpleMessage("Обозначение"),
    "thread_diam": MessageLookupByLibrary.simpleMessage("Диаметр"),
    "thread_diam_nom": MessageLookupByLibrary.simpleMessage(
      "Диаметр (номинальный)",
    ),
    "thread_pitch": MessageLookupByLibrary.simpleMessage("Шаг"),
    "thread_pitch_coarse": MessageLookupByLibrary.simpleMessage(
      "Основной шаг (крупный)",
    ),
    "thread_pitch_fine": MessageLookupByLibrary.simpleMessage("Мелкий шаг"),
    "thread_pitch_superfine": MessageLookupByLibrary.simpleMessage(
      "Сверхмелкий шаг",
    ),
    "thread_series": MessageLookupByLibrary.simpleMessage("Серия резьбы"),
    "thread_tolerance": MessageLookupByLibrary.simpleMessage("Допуск"),
    "thread_type": MessageLookupByLibrary.simpleMessage("Тип резьбы"),
    "threads_info": MessageLookupByLibrary.simpleMessage("Информация о резьбе"),
    "tolerance": MessageLookupByLibrary.simpleMessage("Допуск"),
    "totalTruncation": MessageLookupByLibrary.simpleMessage(
      "3H/8 - Суммарное усечение",
    ),
    "tpi": MessageLookupByLibrary.simpleMessage("Витков на дюйм"),
    "trapezoidal_thread": MessageLookupByLibrary.simpleMessage(
      "Трапецеидальная резьба",
    ),
    "trapezoidal_thread_gost": MessageLookupByLibrary.simpleMessage(
      "ГОСТ 24737-81",
    ),
